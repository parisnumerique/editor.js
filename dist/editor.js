...
/***/ "./src/components/block-tunes/block-tune-add.ts":
/*!******************************************************!*\
  !*** ./src/components/block-tunes/block-tune-add.ts ***!
  \******************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function () {
     ...
     * @param {{api: API}} api
     */
    function AddTune(_ref) {
      var api = _ref.api;
      (0, _classCallCheck2.default)(this, AddTune);
    ...
    (0, _createClass2.default)(AddTune, [{
      key: "render",
      value: function render() {
        var _this = this;

        var addButton = _dom.default.make('div', [this.CSS.button, this.CSS.wrapper], {});

        addButton.appendChild(_dom.default.svg('plus', 14, 14));
        this.api.listeners.on(addButton, 'click', function (event) {
          return _this.handleClick(event, addButton);
        }, false);
        return addButton;
      }
      /**
  ...
  _exports.default = AddTune;
  AddTune.displayName = "AddTune";
  module.exports = exports.default;
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/toConsumableArray.js"), __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js"), __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js"), __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! ./dom */ "./src/components/dom.ts"), __webpack_require__(/*! ./utils */ "./src/components/utils.ts"), __webpack_require__(/*! ./block-tunes/block-tune-add */ "./src/components/block-tunes/block-tune-add.ts"), __webpack_require__(/*! ./block-tunes/block-tune-delete */ "./src/components/block-tunes/block-tune-delete.ts"), __webpack_require__(/*! ./block-tunes/block-tune-move-down */ "./src/components/block-tunes/block-tune-move-down.ts"), __webpack_require__(/*! ./block-tunes/block-tune-move-up */ "./src/components/block-tunes/block-tune-move-up.ts"), __webpack_require__(/*! ./selection */ "./src/components/selection.ts")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _toConsumableArray2, _regenerator, _asyncToGenerator2, _classCallCheck2, _createClass2, _dom, _utils, _blockTuneAdd, _blockTuneDelete, _blockTuneMoveDown, _blockTuneMoveUp, _selection) {
  "use strict";
  ...
  _blockTuneAdd = _interopRequireDefault(_blockTuneAdd);
  ...
  function () {
    ...
    (0, _createClass2.default)(Block, [{
      ...
      value: function makeTunes() {
        ...
        var tunesList = [_blockTuneAdd.default, _blockTuneMoveUp.default, _blockTuneMoveDown.default, _blockTuneDelete.default]; // Pluck tunes list and return tune instances with passed Editor API and settings
  ...
  function () {
    ...
    (0, _createClass2.default)(DomIterator, [{
      ...
      value: function leafNodesAndReturnIndex(direction) {
        ...
        if (_dom.default.isNativeInput(this.items[focusedButtonIndex])) {
          /**
           * Focus input
           */
...
})(this, function (_exports, _classCallCheck2, _createClass2, _domIterator, _utils) {
  "use strict";
  ...
  function () {
    ...
    (0, _createClass2.default)(Flipper, [{
      ...
      value: function isEventReadyForHandling(event) {
        var handlingKeyCodeList = [_utils.default.keyCodes.TAB, _utils.default.keyCodes.ENTER];

        if (this.allowArrows) {
          handlingKeyCodeList.push(_utils.default.keyCodes.LEFT, _utils.default.keyCodes.RIGHT);
        }
      ...
      key: "usedKeys",
      get: function get() {
        return [_utils.default.keyCodes.TAB, _utils.default.keyCodes.LEFT, _utils.default.keyCodes.RIGHT, _utils.default.keyCodes.ENTER];
      }
    }]);
    return Flipper;
  }();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function (_Module) {
    ...
    function BlocksAPI() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(BlocksAPI).apply(this, arguments));
      /**
       * Insert new Block
       *
      ...
      _this.insert = function () {
        var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.config.initialBlock;
    ...
    (0, _createClass2.default)(BlocksAPI, [{
      ...
      value: function insertNewBlock() {
        _utils.default.log('Method blocks.insertNewBlock() is deprecated and it will be removed in next major release. ' + 'Use blocks.insert() instead.', 'warn');
...
})(this, function (_exports, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _utils, _selection, _flipper) {
  "use strict";
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockEvents, [{
      ...
      value: function arrowRightAndDown(event) {
         ...
         */
        if (this.Editor.UI.someToolbarOpened && _flipper.default.usedKeys.includes(event.keyCode)) {
          return;
        }
        /**
        ...
        if (event.shiftKey && event.keyCode === _utils.default.keyCodes.DOWN && shouldEnableCBS) {
      ...
      value: function arrowLeftAndUp(event) {
        ...
        if (event.shiftKey && event.keyCode === _utils.default.keyCodes.UP && shouldEnableCBS) {
      ...
      value: function needToolbarClosing(event) {
        var toolboxItemSelected = event.keyCode === _utils.default.keyCodes.ENTER && this.Editor.Toolbox.opened,
            ...
            inlineToolbarItemSelected = event.keyCode === _utils.default.keyCodes.ENTER && this.Editor.InlineToolbar.opened,
            conversionToolbarItemSelected = event.keyCode === _utils.default.keyCodes.ENTER && this.Editor.ConversionToolbar.opened,
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(BlockSelection, [{
      ...
      value: function clearSelection(reason) {
        ...
        if (this.anyBlockSelected && reason && reason instanceof KeyboardEvent && _utils.default.isPrintableKey(reason.keyCode)) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
...
})(this, function (_exports, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _selection, _utils) {
  "use strict";
  ...
  function (_Module) {
    ...
    function CrossBlockSelection() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(CrossBlockSelection).apply(this, arguments));
      /**
    ...
    (0, _createClass2.default)(CrossBlockSelection, [{
      ...
      value: function watchSelection(event) {
        if (event.button !== _utils.default.mouseButtons.LEFT) {
          return;
        }
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Renderer, [{
      ...
      value: function () {
        ...
        return function insertBlock(_x2) {
          return _insertBlock.apply(this, arguments);
        };
      }()
    }]);
...
})(this, function (_exports, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _dom, _flipper, _utils) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
...
})(this, function (_exports, _regenerator, _asyncToGenerator2, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _dom, _utils, _flipper) {
  "use strict";
  ...
  function (_Module) {
    ...
    function ConversionToolbar() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ConversionToolbar).apply(this, arguments));
      /**
    ...
    (0, _createClass2.default)(ConversionToolbar, [{
       ...
       */
      value: function make() {
        this.nodes.wrapper = _dom.default.make('div', ConversionToolbar.CSS.conversionToolbarWrapper);
      ...
      value: function () {
        ...
        _regenerator.default.mark(function _callee(replacingToolName) {
          ...
          var currentBlockClass, currentBlockName, savedBlock, blockData, replacingTool, exportData, exportProp, newBlockData, importProp, sanitzeConfig, cleaned;
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                ...
                case 4:
                  ...
                  exportData = '';
                  exportProp = currentBlockClass.conversionConfig.export;
                ...
                case 18:
                  _utils.default.log('Conversion «export» property must be a string or function. ' + 'String means key of saved data object to export. Function should export processed string to export.');
                ...
                case 20:
                   ...
                   */
                  newBlockData = {};
                  importProp = replacingTool.conversionConfig.import;
                ...
                case 26:
                  ...
                  sanitzeConfig = this.Editor.Sanitizer.composeToolConfig(replacingToolName)[importProp];
                  cleaned = this.Editor.Sanitizer.clean(exportData, sanitzeConfig);
                  newBlockData[importProp] = cleaned;
                  _context.next = 34;
                  break;

                case 32:
                  _utils.default.log('Conversion «import» property must be a string or function. ' + 'String means key of tool data to import. Function accepts a imported string and return composed tool data.');
        ...
        return function replaceWithBlock(_x) {
      ...
      key: "addTool",
      value: function addTool(toolName, toolIcon) {
        var _this3 = this;
          ...
          return _regenerator.default.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return _this3.replaceWithBlock(toolName);
      ...
      value: function highlightActiveTool(toolName) {
        ...
        Object.values(this.tools).forEach(function (el) {
    ...
    (0, _createClass2.default)(Toolbar, [{
      ...
      value: function make() {
        ...
        this.Editor.Listeners.on(this.nodes.plusButton, 'mouseenter', function () {
          ...
          var fragment = document.createDocumentFragment(); // fragment.appendChild(document.createTextNode('Add'));
...
})(this, function (_exports, _slicedToArray2, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _dom, _selection, _utils, _flipper) {
  "use strict";
    ...
    (0, _createClass2.default)(InlineToolbar, [{
      ...
      value: function make() {
        ...
        this.Editor.Listeners.on(this.nodes.wrapper, 'mousedown', function (event) {
          var isClickedOnActionsWrapper = event.target.closest(".".concat(_this2.CSS.actionsWrapper)); // If click is on actions wrapper,
      ...
      value: function close() {
        ...
        this.nodes.wrapper.classList.remove(this.CSS.inlineToolbarShowed); // N.B.: this is mainly useful to remove the fake highlight on link,
      ...
      value: function open() {
        ...
        var visibleTools = Array.from(this.buttonsList).filter(function (tool) {
          return !tool.hidden;
        });
      ...
      value: function enableShortcuts(tool, shortcut) {
        ...
        this.Editor.Shortcuts.add({
          ...
          handler: function handler(event) {
            ...
            if (!toolSettings || !toolSettings[_this6.Editor.Tools.USER_SETTINGS.ENABLED_INLINE_TOOLS]) {
              return;
            }
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "./node_modules/@babel/runtime/helpers/slicedToArray.js"), __webpack_require__(/*! @babel/runtime/helpers/typeof */ "./node_modules/@babel/runtime/helpers/typeof.js"), __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"), __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/getPrototypeOf.js"), __webpack_require__(/*! @babel/runtime/helpers/inherits */ "./node_modules/@babel/runtime/helpers/inherits.js"), __webpack_require__(/*! ../__module */ "./src/components/__module.ts"), __webpack_require__(/*! ../utils */ "./src/components/utils.ts"), __webpack_require__(/*! ../tools/stub */ "./src/components/tools/stub/index.ts")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _slicedToArray2, _typeof2, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _utils, _stub) {
  "use strict";
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Tools, [{
      ...
      value: function construct(tool, data) {
        ...
        var config = this.toolsSettings[tool][this.USER_SETTINGS.CONFIG] || {}; // Pass placeholder to initial Block config
    ...
    (0, _createClass2.default)(UI, [{
          ...
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 10:
                  _context.next = 12;
                  return this.Editor.ConversionToolbar.make();
      ...
      value: function documentClicked(event) {
        ...
        if (_selection.default.isAtEditor) {
           ...
           */
          if (_selection.default.anchorNode === this.nodes.redactor) {
      ...
      get: function get() {
        var _this$Editor3 = this.Editor,
            Toolbox = _this$Editor3.Toolbox,
            BlockSettings = _this$Editor3.BlockSettings,
            InlineToolbar = _this$Editor3.InlineToolbar,
            ConversionToolbar = _this$Editor3.ConversionToolbar;
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.15.1");
       ...
       * @return {boolean}
       */
      value: function isPrintableKey(keyCode) {
      ...
      value: function deepMerge(target) {
        var isObject = function isObject(item) {
          return item && Util.typeof(item) === 'object';
        };
